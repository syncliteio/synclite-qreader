...
<title>Load SyncLite QReader Job</title>
</head>
		...
		<form action="${pageContext.request.contextPath}/loadJob" method="post">
			<table>
				<tbody>
					<tr>
						<td>Job Name</td>
						<td><input type="text" size = 30 id="job-name" name="job-name" value="<%=jobName%>" onchange="this.form.action='loadJob.jsp'; this.form.submit();" title="Specify SyncLite qreader job name. Make sure that the job name specified here is same as the one specified in SyncLite consolidator"/></td>
					</tr>
