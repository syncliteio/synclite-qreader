...
<title>SyncLite QReader Job Scheduler History</title>
</head>
...
<body>
	...
	<div class="main">
		...
		<%
			...
			Path statsFilePath = Path.of(session.getAttribute("synclite-device-dir").toString(), "synclite_qreader_scheduler_statistics.db");		
