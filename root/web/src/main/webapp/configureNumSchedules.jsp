...
<body>
	...
	<div class="main">
		...
		<%
			...
			if (request.getParameter("synclite-qreader-scheduler-num-schedules") != null) {
				numSchedules = request.getParameter("synclite-qreader-scheduler-num-schedules");
			} else {
				...
				try {
					if (Files.exists(propsPath)) {		
						...
						while (line != null) {
							...
							if (tokenName.equals("synclite-qreader-scheduler-num-schedules")) {
			...
			<table>
				<tbody>
					<tr>
						...
						<td><input type="number" size=5 id="synclite-qreader-scheduler-num-schedules"
							name="synclite-qreader-scheduler-num-schedules"
							value="<%=numSchedules%>"
