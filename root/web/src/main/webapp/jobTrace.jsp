...
<title>SyncLite QReader Job Trace</title>
</head>
...
<body onload="autoRefreshSetTimeout()">
	...
	<div class="main">
		<h2>SyncLite QReader Job Trace </h2>
		<%
			...
			Path jobTraceFilePath = Path.of(session.getAttribute("synclite-device-dir").toString(), "synclite_qreader.trace");
