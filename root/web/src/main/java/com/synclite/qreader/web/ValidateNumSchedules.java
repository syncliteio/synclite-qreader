...
public class ValidateNumSchedules extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String numScedulesStr = request.getParameter("synclite-qreader-scheduler-num-schedules");
			try {
			...
			request.getSession().setAttribute("synclite-qreader-scheduler-num-schedules", numScedulesStr);
