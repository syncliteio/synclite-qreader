	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			if (request.getSession().getAttribute("synclite-device-dir") == null) {
		        ...
		        Scheduler stopperScheduler = (Scheduler) request.getSession().getAttribute("syncite-qreader-job-stopper-scheduler-" + jobName);
		        if (stopperScheduler != null) {
		        	if (!stopperScheduler.isShutdown()) {
		        		stopperScheduler.shutdown();
		        	}
		        	request.getSession().setAttribute("syncite-qreader-job-stopper-scheduler-" + jobName, null);
		        }
