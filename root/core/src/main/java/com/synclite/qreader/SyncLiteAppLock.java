...
public class SyncLiteAppLock {
	...
	public final void tryLock(Path workDir) throws SyncLiteException {		
		this.lockFile = workDir.resolve("synclite_qreader.lock");
		try {
			...
			if (this.lock == null) {
				...
				throw new SyncLiteException("Failed to lock synclite qreader lock " + this.lockFile
						+ ". Please stop any other qreader job running for the specified db-dir : " + workDir
